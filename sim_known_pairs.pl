   ...
   for my $relationship (@rels) {
      for (1..$n_reps) {
         ...
         if ($relationship eq 'DPO') { # both parents are same individual
            ...
            push @genotypes, ($p1_genotype, $o_genotype);
            ...
            push @genotypes, ($o1_genotype, $o2_genotype);
            ...
            push @genotypes, ($c1_genotype, $c2_genotype);
            ...
            push @genotypes, ($p2_genotype, $nn_genotype);
            #    my $c2_genotype = GenotypeSim::draw_offspring_genotype($the_rng, $p2_genotype, $p4_genotype);
            ...
            push @genotypes, ($gp2_genotype, $gc_genotype);
            #    my $c2_genotype = GenotypeSim::draw_offspring_genotype($the_rng, $p2_genotype, $p4_genotype);
        ...
        #    my ($an, $ad, $hn, $hd, $gpc_count) = GenotypeSim::agmr_hgmr($o12_genotype, $o23_genotype);
                  push @genotypes, ($o12_genotype, $o23_genotype);
            ...
            push @genotypes, ($hnn_genotype, $o23_genotype);
            ...
            push @genotypes, ($genotype1, $genotype2);
