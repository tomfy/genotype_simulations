...

{
   ...
   for (1..$n_reps) {
      ...
      if ($relationship eq 'DPO') { # both parents are same individual
         my $p1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         ...
         my $p2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         my $o_genotype = GenotypeSim::draw_offspring_genotype($the_rng, $p1_genotype, $p2_genotype);

         #    GenotypeSim::print_genotype($p1_genotype, $p2_genotype, $o_genotype);
         my ($an, $ad, $hn, $hd, $gpc_count) = GenotypeSim::agmr_hgmr($p1_genotype, $o_genotype);
         ...
         my $gp1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         my $gp2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         ...
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps); # p3, p4 are unrelated
         my $p4_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         ...
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps); # other parent - unrelated
         #   my $p4_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         ...
         my $p1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         my $p2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         ...
         my $genotype1 = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
         my $genotype2 = GenotypeSim::draw_genotype_from_population($the_rng, $maf, $n_snps);
