 ...
 #  print STDERR "AAA: ", join(", ", @$mafs), "\n";
   ...
   for (1..$n_reps) {
      ...
      if ($relationship eq 'DPO') { # both parents are same individual
         my $p1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         ...
         my $p2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
      ...
      #   print GenotypeSim::genotype_string($p1_genotype), "\n";
        #    GenotypeSim::print_genotypes_in_columns($p1_genotype, $p2_genotype, $o_genotype);
         ...
         my $gp1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         my $gp2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         ...
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs); # p3, p4 are unrelated
         my $p4_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         ...
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs); # other parent - unrelated
         #   my $p4_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         ...
         my $p1_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         my $p2_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         my $p3_genotype = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         ...
         my $genotype1 = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
         my $genotype2 = GenotypeSim::draw_genotype_from_population($the_rng, $mafs);
